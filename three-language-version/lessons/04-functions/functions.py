...
# ============================================
# 9. Decorators (Advanced Python Feature)
# ============================================
...
def main():
    ...
    print("\n  Keyword arguments:")
    print(f"  describe_person(age=30, name='Alice'): {describe_person(age=30, name='Alice')}")
    ...
    print(f"  square_then_increment(5): {square_then_increment(5)}")  # 26
    increment_then_square = compose(square, increment)
    print(f"  increment_then_square(5): {increment_then_square(5)}")  # 36

    # 8. Higher-order functions
    print("\n8. Higher-Order Functions:")
    print(f"  apply_twice(increment, 5): {apply_twice(increment, 5)}")
    print(f"  apply_n_times(double, 2, 4): {apply_n_times(double, 2, 4)}")
    ...
    print(f"  reduce(add, numbers, 0): {sum_all}")
    ...
    print("\n=== Summary ===")
    print("Python functions are:")
    print("  - First-class values (can be passed and returned)")
    print("  - Support closures (capture enclosing scope)")
    print("  - Can be pure or impure (no enforcement)")
    print("  - Support default parameters and variadic arguments")
    print("  - Can be decorated for meta-programming")
